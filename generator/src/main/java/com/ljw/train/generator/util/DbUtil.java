package com.ljw.train.generator.util;
...
public class DbUtil {
    ...
    public static String url = "jdbc:mysql://localhost/train_member?characterEncoding=UTF8&autoReconnect=true&serverTimezone=Asia/Shanghai";
